...
return (
		<div className="col-12">
			...
			<div className='main-page'>
				...
				<p>There are many UI components on the pages so be sure to play around and try out the Day/Night style functionality and click or tap to see more information on clients and timeline events.</p>
